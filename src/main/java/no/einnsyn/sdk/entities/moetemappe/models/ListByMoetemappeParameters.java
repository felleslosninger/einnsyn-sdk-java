...
public class ListByMoetemappeParameters {
  ...
  protected String moetemappeId;

  public ListByMoetemappeParameters(
      List<String> expand,
      Integer limit,
    ...
    this.id = id;
    this.moetemappeId = moetemappeId;
  }
  ...
  public static ListByMoetemappeParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder moetemappeId(String moetemappeId) {
      this.moetemappeId = moetemappeId;
      return this;
    }

    public ListByMoetemappeParameters build() {
      return new ListByMoetemappeParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
