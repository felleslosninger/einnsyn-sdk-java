...
public class ListByVedtakParameters {
  ...
  public static ListByVedtakParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder vedtakId(String vedtakId) {
      this.vedtakId = vedtakId;
      return this;
    }

    public ListByVedtakParameters build() {
      return new ListByVedtakParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
