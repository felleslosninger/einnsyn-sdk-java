...
public class ListBySaksmappeParameters {
  ...
  public ListBySaksmappeParameters(
      List<String> expand,
      Integer limit,
  ...
  public static ListBySaksmappeParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder saksmappeId(String saksmappeId) {
      this.saksmappeId = saksmappeId;
      return this;
    }

    public ListBySaksmappeParameters build() {
      return new ListBySaksmappeParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
