...
public class KlassifikasjonssystemRequest extends ArkivBaseRequest {
  ...
  public static KlassifikasjonssystemRequest of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public KlassifikasjonssystemRequest build() {
      return new KlassifikasjonssystemRequest(
