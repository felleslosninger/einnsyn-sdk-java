...
public class ListByKlassifikasjonssystemParameters {
  ...
  public ListByKlassifikasjonssystemParameters(
      List<String> expand,
      Integer limit,
  ...
  public static ListByKlassifikasjonssystemParameters of(
  ...
  public static class Builder {
    ...
    public Builder klassifikasjonssystemId(String klassifikasjonssystemId) {
      this.klassifikasjonssystemId = klassifikasjonssystemId;
      return this;
    }

    public ListByKlassifikasjonssystemParameters build() {
      return new ListByKlassifikasjonssystemParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
