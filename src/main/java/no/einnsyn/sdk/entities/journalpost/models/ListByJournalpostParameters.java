...
public class ListByJournalpostParameters {
  ...
  public ListByJournalpostParameters(
      List<String> expand,
      Integer limit,
  ...
  public static ListByJournalpostParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public ListByJournalpostParameters build() {
      return new ListByJournalpostParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
