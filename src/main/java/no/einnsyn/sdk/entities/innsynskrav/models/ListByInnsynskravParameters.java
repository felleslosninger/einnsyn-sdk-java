...
public class ListByInnsynskravParameters {
  ...
  protected String innsynskravId;

  public ListByInnsynskravParameters(
      List<String> expand,
      Integer limit,
    ...
    this.id = id;
    this.innsynskravId = innsynskravId;
  }
  ...
  public String getInnsynskravId() {
    return innsynskravId;
  }
  ...
  public static ListByInnsynskravParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder innsynskravId(String innsynskravId) {
      this.innsynskravId = innsynskravId;
      return this;
    }

    public ListByInnsynskravParameters build() {
      return new ListByInnsynskravParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
