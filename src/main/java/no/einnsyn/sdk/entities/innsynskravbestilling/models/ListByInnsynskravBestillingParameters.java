...
public class ListByInnsynskravBestillingParameters {
  ...
  protected String innsynskravBestillingId;

  public ListByInnsynskravBestillingParameters(
      List<String> expand,
      Integer limit,
    ...
    this.id = id;
    this.innsynskravBestillingId = innsynskravBestillingId;
  }
  ...
  public String getInnsynskravBestillingId() {
    return innsynskravBestillingId;
  }
  ...
  public static ListByInnsynskravBestillingParameters of(
      Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder innsynskravBestillingId(String innsynskravBestillingId) {
      this.innsynskravBestillingId = innsynskravBestillingId;
      return this;
    }

    public ListByInnsynskravBestillingParameters build() {
      return new ListByInnsynskravBestillingParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
