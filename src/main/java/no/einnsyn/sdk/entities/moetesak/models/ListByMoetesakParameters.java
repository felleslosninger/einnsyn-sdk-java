...
public class ListByMoetesakParameters {
  ...
  public ListByMoetesakParameters(
      List<String> expand,
      Integer limit,
  ...
  public static ListByMoetesakParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public ListByMoetesakParameters build() {
      return new ListByMoetesakParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
