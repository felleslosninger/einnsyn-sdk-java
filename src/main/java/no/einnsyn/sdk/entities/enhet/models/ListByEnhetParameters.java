...
public class ListByEnhetParameters {
  ...
  public static ListByEnhetParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder enhetId(String enhetId) {
      this.enhetId = enhetId;
      return this;
    }

    public ListByEnhetParameters build() {
      return new ListByEnhetParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
