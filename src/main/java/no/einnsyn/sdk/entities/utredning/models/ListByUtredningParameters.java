...
public class ListByUtredningParameters {
  ...
  public ListByUtredningParameters(
      List<String> expand,
      Integer limit,
  ...
  public static ListByUtredningParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder utredningId(String utredningId) {
      this.utredningId = utredningId;
      return this;
    }

    public ListByUtredningParameters build() {
      return new ListByUtredningParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
