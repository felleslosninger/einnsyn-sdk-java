...
public class ListByArkivParameters {
  ...
  public static ListByArkivParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder arkivId(String arkivId) {
      this.arkivId = arkivId;
      return this;
    }

    public ListByArkivParameters build() {
      return new ListByArkivParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
