...
public class ListByBrukerParameters {
  ...
  public static ListByBrukerParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder brukerId(String brukerId) {
      this.brukerId = brukerId;
      return this;
    }

    public ListByBrukerParameters build() {
      return new ListByBrukerParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
