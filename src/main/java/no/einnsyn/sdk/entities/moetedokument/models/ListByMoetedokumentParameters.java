...
public class ListByMoetedokumentParameters {
  ...
  protected String moetedokumentId;

  public ListByMoetedokumentParameters(
      List<String> expand,
      Integer limit,
    ...
    this.id = id;
    this.moetedokumentId = moetedokumentId;
  }
  ...
  public String getMoetedokumentId() {
    return moetedokumentId;
  }
  ...
  public static ListByMoetedokumentParameters of(Function<Builder, Builder> builderFunction) {
  ...
  public static class Builder {
    ...
    public Builder moetedokumentId(String moetedokumentId) {
      this.moetedokumentId = moetedokumentId;
      return this;
    }

    public ListByMoetedokumentParameters build() {
      return new ListByMoetedokumentParameters(
          this.expand,
          this.limit,
          this.sortOrder,
          this.startingAfter,
